...
@interface MoviePlayerController : NSObject <MPMediaPlayback>
...
@interface MoviePlayerController (MovieProperties)
...
// -----------------------------------------------------------------------------
// Thumbnails
@interface MoviePlayerController (MoviePlayerThumbnailGeneration)
...
/**
 ...
 @interface MoviePlayerController (MovieLogging)
